...
| o.j.p/rimuhosting| compute| unassigned | [rimuhosting](http://forums.rimuhosting.com/forumdisplay.php?f=30) | [116/134](/documentation/releasenotes/1.5.0/rimuhosting.txt)| [failures](/documentation/releasenotes/1.5.0/rimuhosting-failures.txt) most failures are due to test itself|
