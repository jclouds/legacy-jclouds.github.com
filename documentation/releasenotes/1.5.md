...
Many of you have been awaiting (or helping build) massive new support for OpenStack based clouds.  There's even more!
...
*  New `rackspace-cloudserver-us` and `rackspace-cloudservers-uk` providers for the [Rackspace open cloud](http://www.rackspace.com/cloud/)
