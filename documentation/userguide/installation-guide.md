...
{% highlight clojure %}
(defproject deps "1" :dependencies [[org.jclouds/jclouds-all "1.5.1"] [org.jclouds.driver/jclouds-sshj "1.5.1"]])
{% endhighlight %}
...
<project default="sync-lib" xmlns:artifact="urn:maven-artifact-ant" >
  <target name="sync-lib" depends="initmvn">
    ...
    <artifact:dependencies filesetId="jclouds.fileset" versionsId="dependency.versions">
      <dependency groupId="org.jclouds.provider" artifactId="aws-s3" version="1.5.1" />
      <dependency groupId="org.jclouds.driver" artifactId="jclouds-gae" version="1.5.1" />
    </artifact:dependencies>
...
:dependencies [[org.clojure/clojure "1.3.0"]
               ...
               [org.jclouds/jclouds-allblobstore "1.5.1"]]
{% endhighlight %}
...
## making your own lib dir
  ...
  * using lein
    * Create a project.clj file with dependencies you need (ex. org.jclouds/jclouds-all) and the snapshot repository, if you want snapshot version (1.6.0-SNAPSHOT)
    * execute lein deps
