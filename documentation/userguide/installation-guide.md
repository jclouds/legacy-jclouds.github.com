...
{% highlight clojure %}
(defproject deps "1" :dependencies [[org.jclouds/jclouds-all "1.5.0"] [org.jclouds.driver/jclouds-sshj "1.5.0"]])
{% endhighlight %}
...
<project default="sync-lib" xmlns:artifact="urn:maven-artifact-ant" >
  <target name="sync-lib" depends="initmvn">
    ...
    <artifact:dependencies filesetId="jclouds.fileset" versionsId="dependency.versions">
      <dependency groupId="org.jclouds.provider" artifactId="aws-s3" version="1.5.0" />
      <dependency groupId="org.jclouds.driver" artifactId="jclouds-gae" version="1.5.0" />
    </artifact:dependencies>
...
:dependencies [[org.clojure/clojure "1.3.0"]
               ...
               [org.jclouds/jclouds-allblobstore "1.5.0"]]
{% endhighlight %}
