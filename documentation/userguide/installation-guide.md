...
{% highlight clojure %}
(defproject deps "1" :dependencies [[org.jclouds/jclouds-all "1.5.2"] [org.jclouds.driver/jclouds-sshj "1.5.2"]])
{% endhighlight %}
...
<project default="sync-lib" xmlns:artifact="urn:maven-artifact-ant" >
  <target name="sync-lib" depends="initmvn">
    ...
    <artifact:dependencies filesetId="jclouds.fileset" versionsId="dependency.versions">
      <dependency groupId="org.jclouds" artifactId="jclouds-all" version="1.5.2" />
      <dependency groupId="org.jclouds.driver" artifactId="jclouds-sshj" version="1.5.2" />
...
{% highlight xml %}
      <dependency groupId="org.jclouds.provider" artifactId="the-provider-id" version="1.5.2" />
{% endhighlight %}
